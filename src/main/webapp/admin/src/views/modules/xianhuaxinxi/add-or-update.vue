	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="上市日期" prop="shangshiriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.shangshiriqi" 
						type="date"
						:readonly="ro.shangshiriqi"
						placeholder="上市日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shangshiriqi" label="上市日期" prop="shangshiriqi">
					<el-input v-model="ruleForm.shangshiriqi" placeholder="上市日期" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xianhuaxiangqing = this.ruleForm.xianhuaxiangqing.replace(reg,'../../../ssmo814wskq/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
