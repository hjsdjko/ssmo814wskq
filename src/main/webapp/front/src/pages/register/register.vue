<template>
	...
	<div class="container" :style='{"minHeight":"100vh","backgroundColor":"0","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221026/dfa16b1e27da4aacaf5408c8a8adddab.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"0","margin":"0","borderRadius":"10px","top":"0","background":"#fff","width":"570px","position":"absolute","right":"0","height":"100%"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"0px 0","lineHeight":"1.5","fontSize":"24px","color":"#ab85d3","textAlign":"center"}'>基于SSM的网上鲜花销售系统 注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='yonghu'" prop="yonghuming">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>用户名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>手机：</div>
				<el-input v-model="registerForm.shouji"  placeholder="请输入手机" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='yonghu'" prop="shengri">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>生日：</div>
                <el-date-picker
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="zhanghao">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="mima">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="touxiang">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
					...
					:multiple="true"
					:fileUrls="registerForm.touxiang?registerForm.touxiang:''"
					@change="kefutouxiangUploadChange"
				></file-upload>
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="xingming">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>姓名：</div>
				<el-input v-model="registerForm.xingming"  placeholder="请输入姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="xingbie">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
                      v-for="(item,index) in kefuxingbieOptions"
                      :key="index"
                      :label="item"
                      :value="item">
                  </el-option>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="nianling">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='kefu'" prop="dianhua">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>电话：</div>
				<el-input v-model="registerForm.dianhua"  placeholder="请输入电话" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="caigougonghao">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>采购工号：</div>
				<el-input v-model="registerForm.caigougonghao" readonly placeholder="请输入采购工号" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="mima">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="caigouxingming">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>采购姓名：</div>
				<el-input v-model="registerForm.caigouxingming"  placeholder="请输入采购姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="touxiang">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="xingbie">
				<div v-if="false" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center","display":"inline-block"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 26px"}' v-if="tableName=='caigou'" prop="lianxidianhua">
...
export default {
    ...
    created() {
      ...
      if ('caigou' == this.tableName) {
        this.rules.caigougonghao = [{ required: true, message: '请输入采购工号', trigger: 'blur' }];
      }
      if ('caigou' == this.tableName) {
        this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
      }
    ...
    methods: {
      ...
      kefutouxiangUploadChange(fileUrls) {
          this.registerForm.touxiang = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`kefu` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
               if(`caigou` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
